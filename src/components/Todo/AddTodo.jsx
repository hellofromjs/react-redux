            ...
            <Modal show={modal} onHide={() => setModal(false)}>
                ...
                `   <Modal.Body>
                        <FormGroup>
                            ...
                            <Form.Control type="text" onChange={handleChange} required value={task.title} name="title" />
                        </FormGroup>
                        <FormGroup>
                            <Form.Label>Aprasymas</Form.Label>
                            <Form.Control type="textarea" onChange={handleChange} style={{height: '100px'}} required value={task.description} name="description" />
                        </FormGroup>
                    </Modal.Body>
                    <Modal.Footer>
